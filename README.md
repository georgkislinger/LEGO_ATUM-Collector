...
2. Copy and paste the contents of the provided script (`ATUM_tape_collector_control.py`) into the editor. Measure your tape reels' diameters (including the tape on the reel) and adjust the variables in script.
